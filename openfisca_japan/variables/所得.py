...
class 給与所得控除額(Variable):
    ...
    def formula_2020_01_01(対象人物, 対象期間, _parameters):
        ...
        if 収入 <= 1625000:
            ...
            return 収入 * 0.4 - 100000
        elif 収入 <= 3600000:
            return 収入 * 0.3 + 80000
        elif 収入 <= 6600000:
            return 収入 * 0.2 + 440000
        elif 収入 <= 8500000:
            return 収入 * 0.1 + 1100000
        else:
            return float(1950000)
    ...
    def formula_2017_01_01(対象人物, 対象期間, _parameters):
        ...
        if 収入 <= 1625000:
            ...
            return 収入 * 0.3 + 180000
        elif 収入 <= 6600000:
            return 収入 * 0.2 + 540000
        elif 収入 <= 10000000:
            return 収入 * 0.1 + 1200000
        else:
            return float(2200000)
