...
class 特別児童扶養手当(Variable):
    ...
    def formula(対象世帯, 対象期間, parameters):
        ...
        上限年齢未満の身体障害者手帳一級人数 = \
            対象世帯.sum((身体障害者手帳等級一覧 == 身体障害者手帳等級認定パターン.一級) & 上限年齢未満の児童)
        上限年齢未満の身体障害者手帳二級人数 = \
            対象世帯.sum((身体障害者手帳等級一覧 == 身体障害者手帳等級認定パターン.二級) & 上限年齢未満の児童)

        手当金額 = \
            上限年齢未満の身体障害者手帳一級人数 * 特別児童扶養手当.金額.一級 + 上限年齢未満の身体障害者手帳二級人数 * 特別児童扶養手当.金額.二級
